...
defaults write com.apple.iCal "InvitationNotificationsDisabled" -bool true # ! UNTESTED

# ========
# Advanced
# ========
# [x] Turn on time zone support (default: off)
defaults write com.apple.iCal "TimeZone support enabled" -bool true # ! UNTESTED
# [ ] Show invitee declines (default: on)
defaults write com.apple.iCal "InviteeDeclineAlerts" -bool false # ! UNTESTED
# [ ] Ask before sending changes to events (default: on)
defaults write com.apple.iCal "WarnBeforeSendingInvitations" -bool false # ! UNTESTED
